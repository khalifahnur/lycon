      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-20">
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-white">
            Why <span className="text-emerald-500">Lycan</span> is The Right Choice for You
          </h2>
        </motion.div>
        ...
        >
          ...
          >
            ...
            <p className="text-gray-600 leading-relaxed">
              Every investment is designed to uplift people and create real
              impact. We believe in building stronger communities through
              meaningful projects that foster growth and development.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-gray-600 leading-relaxed">
              From digital ticketing to modern facilities, we embrace technology
              and progress. Our cutting-edge solutions keep you ahead of the
              competition in today&apos;s fast-paced world.
            </p>
          </motion.div>
          ...
          >
            <div className="relative z-10">
              ...
              <p className="text-blue-100 leading-relaxed mb-8">
                We support pathways in sports, education, and events that
                inspire success. Partner with us to unlock your potential and
