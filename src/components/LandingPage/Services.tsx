    ...
    <section className="bg-[#FAFAFA] relative py-6 sm:py-8 lg:py-10 overflow-hidden">
      <div className="container relative mx-auto flex justify-center px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            <h3 className="text-black text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-medium leading-tight">
              What We Do
            </h3>
            ...
            <div className="recent-articles-wrapper flex flex-col gap-6 sm:gap-8 lg:gap-[1.438rem]">
              ...
              {[
                ...
                },
                {
                  ...
                  bg: "#ff5354",
                  title:
                    "More than just a football field — St. Sebastian Park is a hub for sports and celebrations. Designed as a multi-purpose venue, it is ideal for:",
                  desc: "Football matches and tournaments. Weddings, concerts, and community events. Corporate gatherings and exhibitions. With modern facilities, St. Sebastian Park is where memories are made.",
                  imgAlt: "St. Sebastian Park",
                },
                {
                  tag: "📚 St. Sebastian Academy (Coming Soon)",
                  bg: "#ff5354",
                  title: "Education is the foundation of future success.",
                  desc: "Lycan is investing in St. Sebastian Academy, a school that will merge academics with sports to nurture well-rounded leaders and athletes. The Academy will stand as a symbol of excellence, discipline, and opportunity.",
                  imgAlt: "St. Sebastian Academy",
                },
              ].map((entry, index) => (
                <motion.div
                  key={index}
                  className="recent-articles-wrapper__entry relative group"
                  variants={itemVariants}
                >
                  <a
